...
export const metadata: Metadata = {
	title: "About",
	description:
		"Learn about OpenCodex Talent's mission to connect developers with opportunities worldwide.",
};
...
const VALUES = [
	...
	},
	{
		...
		desc: "Talent knows no borders. We support developers from all countries and every technical background.",
	},
	{
		icon: <Zap size={24} />,
...
const HOW_IT_WORKS = [
	{
		...
		desc: "Set your seniority, role, skills, and availability. Write a README to tell your story.",
	},
	{
		step: "02",
		title: "Show your work",
		desc: "Add your open-source projects, production apps, and GitHub repos.",
	},
	{
		step: "03",
		title: "Get discovered",
		desc: "Companies and teams browse by stack, location, and availability. SEO-optimized profiles help you rank.",
	},
];
		...
		<div style={{ padding: "60px 24px 80px" }}>
			<div className="container-section" style={{ maxWidth: 800 }}>
				...
				<div style={{ textAlign: "center", marginBottom: 72 }}>
					...
					>
						OpenCodex Talent is a professional hub where developers showcase
						their skills, projects, and READMEs — and get found by companies
						that actually understand technical work.
					</p>
