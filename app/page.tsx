		...
		<div>
			...
			>
				...
				<div className="container-section" style={{ position: "relative" }}>
					...
					>
						Browse developer profiles, explore open-source projects, and connect
						with engineers from all countries.
					</p>
			...
			<section style={{ padding: "0 24px 80px" }}>
				<div className="container-section">
					...
					>
						...
						>
							Create your developer profile and get discovered by companies
							worldwide.
						</p>
						<Link
							href="/dashboard"
